                                ...
                                <v-flex md6 xs12>
                                    <v-flex md12 xs12>
                                        <v-card v-if="selectedAssistant">
                                            ...
                                            <v-data-table
                                            :headers="privilegeHeaders"
                                            :items="defaultAssistantPrivileges"
                                            :search="defaultAssistantPrivilegeSearch"
                                            >
                                            <template slot="items" slot-scope="props">
                                                <td>{{ props.item.name }}</td>
                                                <td class="text-xs-right">
                                                    <a class="red--text" @click="removeDefault(props.index)">remove</a>
                                                </td>
                                            </template>
                                            </v-data-table>
                                        </v-card>                                    
                                    ...
                                    <v-flex md12 xs12>
                                        <v-card v-if="selectedAssistant">
                                            ...
                                            <template slot="items" slot-scope="props">
                                                <td>{{ props.item.name }}</td>
                                                <td class="text-xs-right">
                                                    <a class="red--text" @click="removeNew(props.index)">remove</a>
                                                </td>
                                            </template>
                                            </v-data-table>
                                        </v-card>                                    
...
export default{
    ...
    data(){
        return{
            privilegeSearch: '',
            defaultAssistantPrivilegeSearch: '',
            newPrivilegeSearch: '',
            loading: false,
            searchParam: '',
            step: 0,
            ...
            headers: [
                ...
                { text: "Surname", value: "email", align: "center" },
                { text: "Role", value: "authority.name", align: "center" },
                { text: "", value: "option", align: "center" },
    ...
    methods:{
        ...
        removeDefault(index){
            this.defaultAssistantPrivileges.splice(index, 1,);
        },
        save(){
            ...
            this.defaultAssistantPrivileges.map(item => {
